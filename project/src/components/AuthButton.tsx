...
export default function AuthButton() {
  ...
  if (!isClient) return <div className="h-10 w-[116px]" />; // Placeholder
      ...
      {loggedIn ? (
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="h-10 rounded-md border border-zinc-700 bg-transparent px-5 text-sm font-black text-white transition hover:border-zinc-500 hover:bg-white/5"
          >
            Sign Out
          </button>
        </div>
        ...
        <button
          onClick={handleLogin}
          className="flex h-10 items-center gap-2 rounded-md border border-zinc-700 bg-black/35 px-5 text-sm font-black text-white transition hover:border-zinc-500 hover:bg-white/5"
        >
