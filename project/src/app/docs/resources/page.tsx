...
const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Learning Resources", icon: "send", href: "/docs/resources", active: true },
            ...
            {navItems.map((item) => (
              <a
                className={`relative transition hover:text-red-500 ${
                  item.label === "Resources" ? "text-red-500" : ""
                }`}
                href={item.href}
                key={item.label}
        ...
        <section className="px-5 py-6 sm:px-8 lg:px-8">
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--panel-bg)] px-5 py-6 shadow-2xl shadow-[var(--shadow)] sm:px-8">
            ...
            <section className="mt-6">
              <div className="inline-flex items-center gap-2 rounded-md border border-zinc-800 bg-zinc-900 px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-zinc-400">
              ...
              <div className="mt-2 h-1 w-64 rounded-full bg-zinc-800" />
